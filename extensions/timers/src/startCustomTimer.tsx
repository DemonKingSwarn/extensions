import { Action, ActionPanel, Form, getPreferenceValues, Toast, useNavigation } from "@vicinae/api";
...
import { CTInlineArgs, InputField, RayFormEvent, TimerPreferences, Values } from "./backend/types";
