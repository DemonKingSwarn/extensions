...
import { CustomTimer, RawTimer, Timer, TimerLaunchConfig, TimerPreferences } from "./types";
...
import { buildPlaybackCommand, buildTextToSpeechCommand } from "./audio";
...
function buildTimerCommand(
  ...
  const alertSoundString =
    prefs.selectedSound === "speak_timer_name"
      ? buildTextToSpeechCommand(timerName)
