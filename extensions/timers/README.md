...
[Link to the original repo](https://github.com/DemonKingSwarn/timers-for-raycast)

This is a lightweight extension allowing you to start and stop countdown timers, stopwatches, and alarms. It works directly in Vicinae, with no external apps or dependencies required.

If you enjoy using Timers for Vicinae and/or want to support further development, feel free to donate below!
...
_Note: if you do not receive notifications from the timer completion, you may need to allow Vicinae notifications in your desktop settings._
...
- Please check my [personal repo for this extension](https://github.com/DemonKingSwarn/timers-for-raycast) first as I may already be working on a fix, or there may already be an issue/PR for your idea ;) I am also more reachable there for PRs/issues.
- If you decide to file an issue on the main `raycast/extensions` repo, please ping me (`@DemonKingSwarn`) so that I don't miss your request!
- Feel free to reach out to me on the Vicinae community if I have not responded to you in a timely manner.
